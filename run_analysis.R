...
MEANS_by_SubjectActivity <- aggregate(fullXYSubject[,3:68], by=list(Subject=fullXYSubject$Subject, Activity=fullXYSubject$Activity), mean)
...
write.table(MEANS_by_SubjectActivity, "MEANS_by_SubjectActivity.txt", row.names=FALSE, sep="\t")
